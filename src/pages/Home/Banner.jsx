...
import team1 from '../../assets/team/team1.jpg.jpg';
import team2 from '../../assets/team/team2.jpg.jpg' // Ensure the path is correct for your image

const Banner = () => {
  return (
    <div className="hero bg-base-200 min-h-96 screen">
